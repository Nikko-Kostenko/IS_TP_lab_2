...
namespace IS_TP_lab2.Controllers
{
    ...
    public class PhonesController : ControllerBase
    {
        ...
        public PhonesController(Lab2PhoneContext context)
        {
            _context = context;
        }
        ...
        {
           var result = await _context.Phones.Include(g => g.Brand).ToListAsync();
           result.ForEach(x => x.Brand.Phones = null);
           return result;
        ...
        {
            var phone = await _context.Phones.Include(g => g.Brand).FirstOrDefaultAsync(x => x.Id == id);
